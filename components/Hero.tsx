  ...
  return (
    <>
            ...
            >
              <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-800 rounded-2xl p-6 flex flex-col sm:flex-row gap-4 items-center">
                ...
                <button
                  ...
                  className={`px-8 py-3 bg-gradient-to-r from-blue-500 to-blue-700 dark:from-blue-400 dark:to-blue-600 hover:from-blue-600 hover:to-blue-800 dark:hover:from-blue-500 dark:hover:to-blue-700 text-white font-bold rounded-lg shadow-lg transition-all duration-200 transform hover:scale-105 ${isSubmitting ? 'opacity-50 cursor-not-allowed' : ''}`}
                >
      ...
      <SuccessModal
        ...
        title="¡Gracias por ser parte de nuestra beta!"
        message="Te mantendremos informado sobre las últimas actualizaciones y novedades."
      />
    </>
  );
} 